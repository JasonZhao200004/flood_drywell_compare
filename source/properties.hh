#ifndef DUMUX_FLOOD_MAR_POND5M_PROPERTIES_HH
#define DUMUX_FLOOD_MAR_POND5M_PROPERTIES_HH
...
struct Grid<TypeTag, TTag::FloodMarPond5m>
{
    using type = Dune::UGGrid<2>;
};

template<class TypeTag>
struct Problem<TypeTag, TTag::FloodMarPond5m>
{
    using type = WaterAirProblem<TypeTag>;
};

template<class TypeTag>
struct FluidSystem<TypeTag, TTag::FloodMarPond5m>
{
private:
...
template<class TypeTag>
struct SpatialParams<TypeTag, TTag::FloodMarPond5m>
{
private:
    using GridGeometry =
...
template<class TypeTag>
struct UseMoles<TypeTag, TTag::FloodMarPond5m>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct ModelTraits<TypeTag, TTag::FloodMarPond5m>
{
private:
    using BaseTraits =
...
template<class TypeTag>
struct DispersionFluxType<TypeTag, TTag::FloodMarPond5m>
{
...
template<class TypeTag>
struct Formulation<TypeTag, TTag::FloodMarPond5m>
{
    static constexpr auto value = TwoPFormulation::p0s1;
};

template<class TypeTag>
struct GridGeometry<TypeTag, TTag::FloodMarPond5m>
{
private:
 ...
 */
template<class TypeTag>
struct VolumeVariables<TypeTag, TTag::FloodMarPond5m>
{
private:
...
template<class TypeTag>
struct EnableGridGeometryCache<TypeTag, TTag::FloodMarPond5m>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct EnableGridVolumeVariablesCache<TypeTag, TTag::FloodMarPond5m>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct EnableGridFluxVariablesCache<TypeTag, TTag::FloodMarPond5m>
{
    static constexpr bool value = true;
};
