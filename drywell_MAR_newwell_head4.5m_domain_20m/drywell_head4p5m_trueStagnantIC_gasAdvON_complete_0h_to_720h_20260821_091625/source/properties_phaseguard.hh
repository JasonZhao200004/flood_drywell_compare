#ifndef DUMUX_FLOOD_MAR_PHASEGUARD_PROPERTIES_HH
#define DUMUX_FLOOD_MAR_PHASEGUARD_PROPERTIES_HH
...
#include "floodmarprimaryvariableswitch_phaseguard.hh"
...
struct Grid<TypeTag, TTag::FloodMarPhaseGuard>
{
    using type = Dune::UGGrid<2>;
};

template<class TypeTag>
struct Problem<TypeTag, TTag::FloodMarPhaseGuard>
{
    using type = WaterAirProblem<TypeTag>;
};

template<class TypeTag>
struct FluidSystem<TypeTag, TTag::FloodMarPhaseGuard>
{
private:
...
template<class TypeTag>
struct SpatialParams<TypeTag, TTag::FloodMarPhaseGuard>
{
private:
    using GridGeometry =
...
template<class TypeTag>
struct UseMoles<TypeTag, TTag::FloodMarPhaseGuard>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct ModelTraits<TypeTag, TTag::FloodMarPhaseGuard>
{
private:
    using BaseTraits =
...
template<class TypeTag>
struct DispersionFluxType<TypeTag, TTag::FloodMarPhaseGuard>
{
...
template<class TypeTag>
struct Formulation<TypeTag, TTag::FloodMarPhaseGuard>
{
    static constexpr auto value = TwoPFormulation::p0s1;
};

template<class TypeTag>
struct GridGeometry<TypeTag, TTag::FloodMarPhaseGuard>
{
private:
 ...
 */
template<class TypeTag>
struct VolumeVariables<TypeTag, TTag::FloodMarPhaseGuard>
{
private:
...
public:
    using type = FloodMarPhaseGuardTwoPNCVolumeVariables<
        NCTraits<BaseTraits, DT, EDM>>;
};

template<class TypeTag>
struct EnableGridGeometryCache<TypeTag, TTag::FloodMarPhaseGuard>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct EnableGridVolumeVariablesCache<TypeTag, TTag::FloodMarPhaseGuard>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct EnableGridFluxVariablesCache<TypeTag, TTag::FloodMarPhaseGuard>
{
    static constexpr bool value = true;
};
