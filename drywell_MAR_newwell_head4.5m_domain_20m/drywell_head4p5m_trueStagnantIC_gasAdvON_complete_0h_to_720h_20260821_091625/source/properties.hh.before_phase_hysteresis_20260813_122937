...
// Flood-MAR oxygen initialization problem
template<class TypeTag>
...
// Enable project-local transient two-phase mechanical dispersion without
// changing the installed DuMuX headers.
template<class TypeTag>
...
public:
    using type =
        FloodMarDispersionModelTraits<BaseTraits>;
};
...
{
    using type =
        FloodMarTransientCCTpfaDispersionFlux<
            TypeTag,
