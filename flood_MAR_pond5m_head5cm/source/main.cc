...
// This model uses an unstructured UGGrid loaded from a Gmsh file.
...
#include "floodmarchoppednewtonsolver.hh"
...
int main(int argc, char** argv)
{
    ...
    do
    {
        // Never step across a change point in the time-variable pond
