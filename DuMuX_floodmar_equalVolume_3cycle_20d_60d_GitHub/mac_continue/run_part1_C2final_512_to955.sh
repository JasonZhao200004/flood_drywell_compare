...
"$EXE" "$PKG/model/params.input" \
  ...
  -Restart.Enable true \
  -Restart.File "$PKG/restart/floodmar_pond5m_head5cm_equalVolume_3cycle_60d_formal_v1_restart_from_00512.dat" \
  -Restart.WriteAtEnd false \
  -Problem.Name floodmar_FINAL_C2_512_to955_1h \
  ...
  -Problem.Cycle3ShutdownStartHours 9999 \
