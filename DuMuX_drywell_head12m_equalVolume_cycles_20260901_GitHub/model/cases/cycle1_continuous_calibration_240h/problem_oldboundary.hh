...
private:
    ...
    {
        // Continuous-wetting equal-volume calibration.
        //
        // Keep all production-model physics and the original
        // startup water-level ramp. Only remove the wet/dry
        // operating schedule: prescribed drywell head remains
        // at DrywellInjectionHead throughout the simulation.
