...
private:
    ...
    {
        // Equal-volume Cycle 1 schedule.
        //
        // Wetting:
        //   0 <= t <= 176.490541 h
        //
        // Drainage:
        //   176.490541 h < t <= 240 h
        //
        // The wetting duration was calibrated from the exact drywell
        // Robin inflow so that cumulative gross injection matches
        // Flood MAR cycle-1 volume = 3769.844 m3.
        constexpr Scalar wetEndHours = 176.490541;

        const Scalar timeHours = timeSeconds/3600.0;

        return timeHours <= wetEndHours
               ? drywellInjectionHeadCm_
               : Scalar(-25.0);
    }
