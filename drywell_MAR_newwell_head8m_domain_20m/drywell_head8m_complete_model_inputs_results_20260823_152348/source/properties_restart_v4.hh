#ifndef DUMUX_FLOOD_MAR_RESTART_V4_PROPERTIES_HH
#define DUMUX_FLOOD_MAR_RESTART_V4_PROPERTIES_HH
...
struct Grid<TypeTag, TTag::FloodMarRestartV4>
{
    using type = Dune::UGGrid<2>;
};

template<class TypeTag>
struct Problem<TypeTag, TTag::FloodMarRestartV4>
{
    using type = WaterAirProblem<TypeTag>;
};

template<class TypeTag>
struct FluidSystem<TypeTag, TTag::FloodMarRestartV4>
{
private:
...
template<class TypeTag>
struct SpatialParams<TypeTag, TTag::FloodMarRestartV4>
{
private:
    using GridGeometry =
...
template<class TypeTag>
struct UseMoles<TypeTag, TTag::FloodMarRestartV4>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct ModelTraits<TypeTag, TTag::FloodMarRestartV4>
{
private:
    using BaseTraits =
...
template<class TypeTag>
struct DispersionFluxType<TypeTag, TTag::FloodMarRestartV4>
{
...
template<class TypeTag>
struct Formulation<TypeTag, TTag::FloodMarRestartV4>
{
    static constexpr auto value = TwoPFormulation::p0s1;
};

template<class TypeTag>
struct GridGeometry<TypeTag, TTag::FloodMarRestartV4>
{
private:
 ...
 */
template<class TypeTag>
struct VolumeVariables<TypeTag, TTag::FloodMarRestartV4>
{
private:
...
template<class TypeTag>
struct EnableGridGeometryCache<TypeTag, TTag::FloodMarRestartV4>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct EnableGridVolumeVariablesCache<TypeTag, TTag::FloodMarRestartV4>
{
    static constexpr bool value = true;
};

template<class TypeTag>
struct EnableGridFluxVariablesCache<TypeTag, TTag::FloodMarRestartV4>
{
    static constexpr bool value = true;
};
