...
#ifndef DUMUX_FLOODMAR_HYDRUSLIKE_NOGASO2ADV_LOCAL_RESIDUAL_HH
#define DUMUX_FLOODMAR_HYDRUSLIKE_NOGASO2ADV_LOCAL_RESIDUAL_HH
...
class FloodMarHydrusLikeNoGasO2AdvLocalResidual
                            ...
                            const ElementFluxVariablesCache& elemFluxVarsCache) const
    {
        ...
        for (int phaseIdx = 0; phaseIdx < numPhases; ++phaseIdx)
        {
            ...
            for (int compIdx = 0; compIdx < numComponents; ++compIdx)
            {
                ...
                // HYDRUS-like gas-O2 diagnostic:
                // O2 retains liquid-phase advection but does not advect
                // with the Darcy gas flux. The suppressed O2 gas
                // advective flux is assigned to inert N2 so that bulk
                // gas transport and gas-pressure dynamics are preserved.
                if (eqIdx != replaceCompEqIdx)
                {
