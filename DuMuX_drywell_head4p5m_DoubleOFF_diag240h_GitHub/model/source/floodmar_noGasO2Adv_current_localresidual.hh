...
#ifndef DUMUX_FLOODMAR_CURRENT_NO_GAS_O2_ADV_LOCAL_RESIDUAL_HH
#define DUMUX_FLOODMAR_CURRENT_NO_GAS_O2_ADV_LOCAL_RESIDUAL_HH
...
class FloodMarCurrentNoGasO2AdvLocalResidual
                            ...
                            const ElementFluxVariablesCache& elemFluxVarsCache) const
    {
        ...
        for (int phaseIdx = 0; phaseIdx < numPhases; ++phaseIdx)
        {
            ...
            for (int compIdx = 0; compIdx < numComponents; ++compIdx)
            {
                ...
                // Diagnostic: suppress ONLY gas-phase O2 advection.
                // Liquid O2 advection remains unchanged.
                // The suppressed gas-O2 advective molar flux is assigned
                // to inert N2 so that bulk gas Darcy transport and pressure
